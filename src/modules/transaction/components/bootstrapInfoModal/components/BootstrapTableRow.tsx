...
import styles from '../../infoModal/infoModalStyle.module.css';
...
const BootstrapTableRow: React.FC<Props> = ({handleDelete, handleOpenEdit, event}) => {
...
export default BootstrapTableRow;
